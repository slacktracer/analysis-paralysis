...
void main() {
    ...
    vec2 center1 = vec2(-0.8, 0.0);
    vec2 center2 = vec2(0.0, 0.0);
    vec2 center3 = vec2(0.6, 0.0);

    // Modulate intensity with time
    float intensity1 = 0.5 + 0.5 * sin(time);       // Intensity varying between 0 and 1
    float intensity2 = 0.5 + 0.5 * sin(time + 2.0);   // Different phase for each glow
